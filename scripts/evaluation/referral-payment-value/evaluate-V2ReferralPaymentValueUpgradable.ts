...
// --------------------------------------------------------------------------------------------------------------------
// Evaluation script for V2ReferralPaymentValueUpgradable Contract
// !!! IMPORTANT NOTE !!!:
// Evaluation script executes all required txs to complete referral processes for participating users
// HOWEVER: Rewards are not distributed yet --> users would have to claim rewards which adds again additional costs
// --------------------------------------------------------------------------------------------------------------------

const CONTRACT = "V2ReferralPaymentValueUpgradable";

type CONTRACT_TYPE = V2ReferralPaymentValueUpgradable;
