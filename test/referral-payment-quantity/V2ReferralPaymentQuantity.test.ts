...
import { V2ReferralPaymentQuantityUpgradable } from "../../typechain-types/contracts/referral-evaluators/referral-payment-quantity/V2ReferralPaymentQuantityUpgradable";

const CONTRACT_NAME = "V2ReferralPaymentQuantityUpgradable";
...
describe(`Testing ${CONTRACT_NAME} Referral Contract`, async () => {
  ...
  const defaultFixture = async () => {
    return deployPaymentQuantityUpgradableFixture<V2ReferralPaymentQuantityUpgradable>(
      {
